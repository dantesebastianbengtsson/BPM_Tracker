...
(function () {
    ...
    function openPartForm(part = null) {
        ...
        const fallbackCurrent =
            part?.currentBpm ??
            (song.parts[song.parts.length - 1]?.currentBpm || 60);
        const fallbackTarget =
            part?.targetBpm ??
            (song.parts[song.parts.length - 1]?.targetBpm || 80);
    ...
    function renderSongDetails() {
        ...
        if (!song) {
            ...
            elements.partList.innerHTML =
                "<p class='notes'>No song selected.</p>";
            return;
        }
            ...
            partDiv.innerHTML = `
                <div class="part-header">
                    <div>
                        ...
                        <p class="notes">Current: ${part.currentBpm} BPM &middot; Target: ${part.targetBpm} BPM</p>
                        ${
                            part.comment
                ...
                <div class="progress-section">
                    ...
                    <div class="progress-bar">
                        <div class="progress-bar-fill ${status.className}" style="width:${
                            progress * 100
                        }%"></div>
                    </div>
                </div>
    ...
    function updateMetronomeDisplay() {
        ...
        if (part) {
            ...
            elements.activePartLabel.textContent = `${getActiveSong().name} - ${part.name}`;
